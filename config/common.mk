...
LINEAGEX_VERSION := 1.2-EOL

LINEAGE_VERSION := LineageX-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-$(LINEAGEX_VERSION)-$(LINEAGE_BUILDTYPE)
LINEAGE_DISPLAY_VERSION := LineageX-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(LINEAGE_BUILD)-$(LINEAGEX_VERSION)-$(LINEAGE_BUILDTYPE)
